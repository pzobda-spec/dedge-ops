-- Implementation cockpit: client-readiness gate, execution phases and workstream planning.
...
CREATE INDEX IF NOT EXISTS idx_onboarding_implementation_phase
  ON onboarding_projects(implementation_phase);
...
CREATE INDEX IF NOT EXISTS idx_project_resources_project
  ON project_resource_requirements(project_id);
CREATE INDEX IF NOT EXISTS idx_project_resources_status
  ON project_resource_requirements(status);
...
CREATE INDEX IF NOT EXISTS idx_project_milestones_project
  ON project_implementation_milestones(project_id);
