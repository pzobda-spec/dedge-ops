  ...
  try {
    ...
    const accounts = plan.pipeline.entries.map(entry => {
      ...
      return {
        ...
        additionalObProjects: assignment?.additionalObProjects ?? entry.account.hotels,
        ...
        expectedGoLiveDate: entry.expectedGoLiveDate,
        goLiveDateSource: entry.goLiveDateSource,
