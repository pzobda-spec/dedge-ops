  ...
  try {
    ...
    return NextResponse.json({
      ...
      unavailable: {
        ...
        implementation: 'Les débuts renseignés utilisent la date de démarrage Zoho Projects, qui peut être planifiée et ne certifie pas un lancement client. Ventilation CRM, Dmbook et produit non classé. Les transitions Non démarré → In Progress sont conservées à part comme signal observé ; les reprises et imports ne sont pas assimilés à un lancement. Live utilise le champ Live date renseigné, sinon une transition observée ; les remises en Live successives ne sont pas toutes historisées.',
